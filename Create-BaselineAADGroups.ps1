...
If ($PSBoundParameters.ContainsKey("Windows")  -or $PSBoundParameters.ContainsKey("All"))
{
    Try
    {
		...
		New-MgGroup -DisplayName 'Intune-Win10-Version-20H2' -grouptypes DynamicMembership -membershiprule '(device.deviceOSType -eq "Windows") and (device.deviceOSVersion -contains "10.0.19042")' -MailEnabled:$False -MailNickname 'Win10-20H2' -SecurityEnabled -MembershipRuleProcessingState On

		New-MgGroup -DisplayName 'Intune-Win10-Version-21H1' -grouptypes DynamicMembership -membershiprule '(device.deviceOSType -eq "Windows") and (device.deviceOSVersion -contains "10.0.19043")' -MailEnabled:$False -MailNickname 'Win10-21H1' -SecurityEnabled -MembershipRuleProcessingState On

		New-MgGroup -DisplayName 'Intune-Win10-Version-21H2' -grouptypes DynamicMembership -membershiprule '(device.deviceOSType -eq "Windows") and (device.deviceOSVersion -contains "10.0.19044")' -MailEnabled:$False -MailNickname 'Win10-21H2' -SecurityEnabled -MembershipRuleProcessingState On

		New-MgGroup -DisplayName 'Intune-Win10-Version-22H2' -grouptypes DynamicMembership -membershiprule '(device.deviceOSType -eq "Windows") and (device.deviceOSVersion -contains "10.0.19045")' -MailEnabled:$False -MailNickname 'Win10-22H2' -SecurityEnabled -MembershipRuleProcessingState On
